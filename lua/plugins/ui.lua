...
return {
	...
	},
	{
		...
		config = function()
			...
			custom_catppuccin.normal.b.bg = "#fab387"
			custom_catppuccin.insert.b.bg = "#fab387"
			custom_catppuccin.visual.b.bg = "#fab387"
			custom_catppuccin.replace.b.bg = "#fab387"
			custom_catppuccin.command.b.bg = "#a6e3a1"
